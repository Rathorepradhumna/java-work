...
public class RandomIntegers {
	public static void generateRandomIntegers(String location) throws IOException {
	...
	public static void printRandomNumber(String location) throws IOException {
	...
	public static void main(String agrs[]) throws IOException {
		...
		generateRandomIntegers(location);
		printRandomNumber(location);
		}
}	
